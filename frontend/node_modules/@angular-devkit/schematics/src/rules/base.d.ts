 ...
 */
import { FileOperator, Rule, Source } from '@angular-devkit/schematics/src/engine/interface';
import { FilePredicate, MergeStrategy, Tree } from '@angular-devkit/schematics/src/tree/interface';
/**
