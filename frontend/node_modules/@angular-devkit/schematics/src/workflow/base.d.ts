...
import { Engine, EngineHost } from '@angular-devkit/schematics/src/engine';
import { DryRunEvent } from '@angular-devkit/schematics/src/sink/dryrun';
import { Sink } from '@angular-devkit/schematics/src/sink/sink';
import { LifeCycleEvent, RequiredWorkflowExecutionContext, Workflow, WorkflowExecutionContext } from '@angular-devkit/schematics/src/workflow/interface';
